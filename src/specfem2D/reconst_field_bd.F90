...
!Note: in this implementation, in contrast to treating the exciations as virtual sources, we consider them
!as boundary condition, which will be supplied exactly to the corresponding GLL points.
!Jan 12, 2017
...
subroutine locate_virtual_bd_pnt()
  ...
  use specfem_par, only: nspec_bd_pnt_elastic,ispec_bd_elmt_elastic,&
